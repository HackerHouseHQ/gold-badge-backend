    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Add state</h6>
                    ...
                    <div class="row">
                      <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-heading"> <label>Enter New State</label> </div>
                          <div class="panel-body">
                            ...
                            @endif
                            <form class="form-horizontal" method="POST" action="{{route('add_state')}}"
                              enctype="multipart/form-data">
                              {{ csrf_field() }}
                              <?php $countryList =  App\Country::get();?>
                              <br>
                              <select name="country_id" id="country_id" class="form-control formn_custom_class_add_form"
                                required>
                              ...
                              <p><b>OR</b></p><br>
                              <div class="col-md-6">
                                <input type="file" class="form-control" placeholder="fghj" name="state_file"
                                  style="display: block;">
                                <a href="http://localhost/gold_badge/storage/app/public/csvformat/state.csv"
                                  class="btn btn-sm btn-success">State CSV
                                  Sample</a>
                              </div>
