    ...
    <div class="navbar-inner">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            {{-- <a href="{{ route('user') }}" class="nav-link custom_navv_linkk homee_divv class_inside_anchorr
            @if(request()->route()->getName()=='user') active
            ...
            <a class="nav-link" href="{{ route('user') }}" data-toggle="collapse" role="button" aria-expanded="false"
