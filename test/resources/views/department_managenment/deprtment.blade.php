    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Department List</h6>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
            ...
            <div class="table-responsive">
              <form id="formId" class="form-horizontal" action="{{route('AddDepartment')}}"
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <select class="form-control select2" style="width: 100%;" id="country1" name="country" required>
                  ...
                  <div class="form-group row">
                    <select class="form-control select2" style="width: 100%;" id="state" name="state" required>
                      <option selected="selected">State Name</option>
                    </select>
                  </div>
                  <div class="form-group row">
                    <select class="form-control select2" style="width: 100%;" id="city1" name="city" required>
      ...
      <div class="modal-footer">
        ...
        <button id="depart" type="button" class="btn btn-primary ">Add</button>
