...
class UserController extends Controller
{
  ...
  public function UserRequestData(Request $request)
  {
    ...
    // print_r($data); die;
    $count = $this->UserRequest->getdata_count($order_by, $offset, $limit_t, $type, $search, $fromdate, $todate);
  ...
  public function manage_request_data($data, $type)
  {
    ...
    foreach ($data as $key => $data) {
      ...
      if ($type == 0) {
        ...
        $reject = "<a href='javascript:void(0)' onclick ='reject(" . $data->id . ',' . 2 . ")'><span class='tbl_row_new1 view_modd_dec'>Reject</span></a><br>";
