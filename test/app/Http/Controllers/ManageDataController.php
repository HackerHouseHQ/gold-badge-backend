...
class ManageDataController extends Controller
{
    ...
    public function manage_data($data)
    {
        ...
        foreach ($data as $key => $data) {
            ...
            $view = "<a href='javascript:void(0)' onclick ='viewDepartmentModel1(" . $data->country_id . ")'><span class='view_modd_dec'>View Country Department</span></a><br>";
            ...
            $viewCity = "<a href='javascript:void(0)' onclick ='viewCityModel1(" . $data->country_id . ")'><span class=' view_modd_dec'>View City List</span></a>";
            ...
            $EditCity = "<a href='javascript:void(0)' onclick ='EditCityModel1(" . $data->country_id . ")'><span class='view_modd_dec'>Edit City List</span></a>";
