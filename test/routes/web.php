...
Route::get('/reset-password', 'Auth\ForgotPasswordController@resetPasswordPage')->name('forgot-password');
Route::post('/changepassword', 'Auth\ForgotPasswordController@resetPassword')->name('changePassword');
