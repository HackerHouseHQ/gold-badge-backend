                                ...
                                <div class='col-5'>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control datepicker" placeholder="Select from date"
                                ...
                                <div class='col-5'>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control datepicker" placeholder="Select to date"
                        ...
                        <div class="table-responsive">
                            <form id="formId" class="form-horizontal" action="{{route('AddDepartment')}}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <select class="form-control select2" style="width: 100%;" id="country1"
                                            name="country">
                                    ...
                                    <div class="form-group row">
                                        <select class="form-control select2" style="width: 100%;" id="city1"
                                            name="city">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="exampleInputFile">Pick
                                                    Icon</label>
                                            </div>
                                        </div>
                                    </div>
