    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <a class="btn btn-sm btn-neutral" href="{{route('terms')}}" style="background-color:#e8c046">Terms &
            Condition</a>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-12">
            ...
            <form action="{{route('edit_terms')}}" method="post">
              ...
              <div class="card-body pad">
                <div class="mb-3">
                  <textarea class="textarea" name="terms" placeholder="Enter text ..." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px;">{{@$Terms->terms}}</textarea>
                </div>
                <div class="row">
