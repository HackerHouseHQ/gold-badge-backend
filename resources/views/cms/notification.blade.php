        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('sendNotification')}}" method="get">
                    <div class="form-group">
                        <input class="form-control" type="title" name="title" placeholder="Notification Title"
                            value=""><br>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form a>
                    <div class="form-group">
                        Title:-
                        <input class="form-control" type="title" name="title" id="title1" value="" readonly><br>
                    </div>
                    <div class="form-group">
                        Desscription:-
