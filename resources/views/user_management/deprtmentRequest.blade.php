                ...
                <div class="col-lg-6 col-6 d-flex justify-content-end">
                  ...
                  id="approve">Approved</a></li> -->
                        ...
                        <li class="show" style="margin-right: 0px !important"><a
                                style="border-bottom: 2px solid #61cf8a;" href="{{route('departmentRequest')}}"
                                class="btn btn-success" data-toggle="notify" data-placement="top" data-align="center"
                                data-type="success" data-icon="ni ni-bell-55">Approved</a></li>
