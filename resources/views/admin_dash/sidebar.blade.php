...
<aside class="main-sidebar elevation-1 custom_class_sdbr">
 <a href="#" class="brand-link custom_brand_link">
  <img src="{{ asset('admin_css/images/Login_logo.png') }}" class="brand-image"style="opacity: .8"><span class="brand-text font-weight-light heading_mainn"><span class="admin_text">
 ...
 <div class="sidebar">
   ...
   <nav class="mt-2">
    <ul class="nav custom_navv nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
