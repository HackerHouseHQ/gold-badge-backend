                        ...
                        <form class="form-horizontal" method="POST" action="{{route('changePassword')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="old_password"
                                    id="exampleFormControlInput1" value="{{ old('old_password') }}" required
                            ...
                            <div class="form-group">
                                <label class="form-control-label" for="exampleFormControlInput1">Confirm
                                    Password</label>
