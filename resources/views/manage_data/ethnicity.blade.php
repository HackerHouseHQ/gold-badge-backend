      ...
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          {{-- <div class="row-lg-6 row-5"> --}}
            ...
            <a href="{{route('ethnicity')}}" class="btn btn-sm btn-neutral mb-1"
            ...
            <tbody>
              ...
              <tr>
                ...
                <td> <button class="btn btn-info btn-sm" data-toggle="modal"
                      ...
                      Edit</button></td>
                <td><a
                      href="{{route('DeleteEthnicity',$ethnicityData->id)}}"><button class="btn btn-danger btn-sm">Delete</button></a>
                </td>
              </tr>
              @endforeach
            </tbody>
