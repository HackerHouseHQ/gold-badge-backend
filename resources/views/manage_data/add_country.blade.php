          ...
          <div class="card-body">
            ...
            <form class="form-horizontal" method="POST" action="{{route('add_country')}}" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-9">
                  <div class="form-group">
                    <input type="file" class="form-control" name="country_file">
                  </div>
                </div>
                <div class="col-3">
                  <div class="form-group">

                    <a href="{{route('countryExport')}}" class="btn btn-primary">File
                      upload sample</a>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-12">
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <!-- Card body -->
              <div class="card-body">
                <form class="form-horizontal" method="POST" action="{{route('add_country')}}">
                     {{ csrf_field() }}
                  <div class="form-group">
                    <label class="form-control-label" for="exampleFormControlInput1">County Name</label>
                    <input type="text" class="form-control" name="country_name" id="exampleFormControlInput1"   value="{{ old('counry_name') }}" required placeholder="Enter Country Name">
                  </div>
