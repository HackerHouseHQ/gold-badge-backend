        ...
        <div class="header-body">
          ...
          <a href="#" class="btn btn-sm btn-neutral">Filters</a> --}}
                    <div class="row-lg-6 row-5">
                        ...
                        <a href="{{route('report-message')}}" class="btn btn-sm btn-neutral"
                            style="background-color:#fb6340;color:#fff;">Report</a>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <button type="button" class="btn btn-default"> <a
                                        ...
                                        href="{{route('add_country_page')}}" class="btn btn-sm btn-neutral">Add Country
                                        +</a></button>
                            </div>
                            <div class="col-3">
                                <button type="button" class="btn btn-default"> <a
                                        style="background-color: #e4bd46;  color:#fff;font-size: 15px;"
                                        href="{{route('add_state_page')}}" class="btn btn-sm btn-neutral">Add State
                                        +</a></button>
                            </div>
                            ...
                            <div class="col-3">
                                <button type="button" class="btn btn-default"> <a
                                        style="background-color: #e4bd46;  color:#fff;font-size: 15px;"
                                        href="{{route('add_city_page')}}" class="btn btn-sm btn-neutral">Add City
                                        +</a></button>
                            </div>
                            <div class="col-3">
                                <button type="button" class="btn btn-default"><a
                                        style="background-color: #e4bd46;  color:#fff;font-size: 15px;"
                                        href="{{route('add_ethnicity_page')}}" class="btn btn-sm btn-neutral">Add
                                        Ethnicity +</a></button>
                            </div>
                            ...
                            <div class="col-3 py-2">
                                <button type="button" class="btn btn-default"><a
                                        style="background-color: #e4bd46;  color:#fff;font-size: 15px;"
                                        href="{{route('showAddReportform')}}" class="btn btn-sm btn-neutral">Add Rating
                                        Question
                                        +</a></button>
                            </div>
                            <div class="col-3 py-2">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-capitalize" id="businessName"> Edit Report</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <form action="{{route('updatReportMessage')}}" method="GET">
...
<script type="text/javascript">
    ...
    // alert(id);
    $.ajax({
      url: "{{ route('Show_edit_report_message') }}/" + id,
      type: 'get',
      success: function(response) {
        ...
        let row = `
                ...
                <input type="text" name="message" value = "${response.message}">
